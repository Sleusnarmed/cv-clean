...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      {/* Header (igual que en Home.jsx) - Modificado para ser responsive */}
      <header className="bg-[#1a2d6b] py-5 px-4 sm:px-6 md:px-12 flex flex-col sm:flex-row items-center justify-between border-b border-blue-800 gap-4">
        <div className="flex items-center space-x-3">
          <Link
            to="/"
            className="text-[#1a2d6b] px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-lg transition-all duration-200 shadow-sm flex items-center space-x-1 text-sm sm:text-base"
          >
            <img
        ...
        {isLoggedIn ? (
          ...
          <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 mb-8">
              Ingresa para crear tu CV profesional
            </p>
